                ...
                with gr.Tabs(elem_id="sadtalker_driven_audio"):
                    with gr.TabItem('Driving Methods'):
                        ...
                        with gr.Row():
                            ...
                            driven_audio_no = gr.Audio(label="Use IDLE mode, no audio is required", source="upload",
                        ...
                        with gr.Row():
                            ref_video = gr.Video(label="Reference Video", source="upload", type="filepath",
                                                 elem_id="vidref").style(width=512)
                    ...
                    with gr.TabItem('Settings'):
                        ...
                        with gr.Column(variant='panel'):
                            ...
                            with gr.Row():
                                ...
                                exp_weight = gr.Slider(minimum=0, maximum=3, step=0.1, label="expression scale",
                                                       value=1)  #
