...
def generate_blink_seq_randomly(num_frames):
    ...
    blink_interval = range(50, 100)
    start = random.choice(blink_interval)
    blink_intensity = [1, 2, 1]
...
def get_data(first_coeff_path, audio_path, device, ref_eyeblink_coeff_path, still=False, idlemode=False,
